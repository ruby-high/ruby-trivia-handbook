...
*~15 min. Recap → round the room → this week's calls. Keep it tight.*

## Since last time (shipped)
...
- **Steam** — account up, build to submit.
...
- **Tweet queue is live** — Draft → approve → Posted.

---
[← This week](plan) · [Calendar](calendar) · [Thursday Space](space)
