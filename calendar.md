...
What's coming — so nobody misses it. Times in **ET** unless noted.

## Recurring
- **Standup — Wednesday AM** — quick sync: progress → blockers → today. → [agenda](standup)
- **Posts — ~1 every 5 hours** — grab from the [pile](posts); pre-schedule on busy days. → [playbook](playbook)
...
---
[← Handbook home](/) · [Posts](posts) · [Playbook](playbook)
